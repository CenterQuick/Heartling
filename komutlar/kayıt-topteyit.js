...
if(!message.member.roles.cache.some(r => ['796056229797429268', '796056220045541437', "796056210537054229"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
